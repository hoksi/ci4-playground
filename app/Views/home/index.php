...
<div class="row g-4">
        ...
        <div class="card h-100 border-0 shadow-sm" style="border-top: 4px solid #fd7e14 !important;">
            <div class="card-body">
                <div class="d-flex align-items-center gap-3 mb-3">
                    <div class="rounded-circle d-flex align-items-center justify-content-center"
                         style="width:48px;height:48px;background:#fff8f0;">
                        <i class="bi bi-shield-exclamation fs-4" style="color:#fd7e14;"></i>
                    </div>
                    <div>
                        <h5 class="mb-0">예외 처리</h5>
                        <small class="text-muted">Exception Handling</small>
                    </div>
                </div>
                <p class="text-muted small mb-3">PageNotFoundException, 커스텀 예외 클래스, try/catch, 글로벌 예외 핸들러 패턴을 학습합니다.</p>
                <div class="d-flex flex-wrap gap-1 mb-3">
                    <span class="badge bg-light text-dark border">PageNotFoundException</span>
                    <span class="badge bg-light text-dark border">try/catch</span>
                    <span class="badge bg-light text-dark border">커스텀 예외</span>
                    <span class="badge bg-light text-dark border">글로벌 핸들러</span>
                </div>
            </div>
            <div class="card-footer bg-white border-0 pt-0">
                <a href="<?= base_url('examples/exception') ?>" class="demo-btn" style="background:#fd7e14;">
                    <i class="bi bi-arrow-right-circle"></i> 예제 보기
                </a>
            </div>
        </div>
        ...
        <div class="card h-100 border-0 shadow-sm" style="border-top: 4px solid #6f42c1 !important;">
            <div class="card-body">
                <div class="d-flex align-items-center gap-3 mb-3">
                    <div class="rounded-circle d-flex align-items-center justify-content-center"
                         style="width:48px;height:48px;background:#f5f0ff;">
                        <i class="bi bi-collection-play fs-4" style="color:#6f42c1;"></i>
                    </div>
                    <div>
                        <h5 class="mb-0">큐(Queue) 시스템</h5>
                        <small class="text-muted">DB-based Job Queue</small>
                    </div>
                </div>
                <p class="text-muted small mb-3">DB 기반 커스텀 큐 — 잡 추가(push) · 처리(process) · 재시도(retry) · 실패 관리까지 큐 시스템 전체 흐름 실습.</p>
                <div class="d-flex flex-wrap gap-1 mb-3">
                    <span class="badge bg-light text-dark border">push/pop</span>
                    <span class="badge bg-light text-dark border">retry</span>
                    <span class="badge bg-light text-dark border">failed jobs</span>
                    <span class="badge bg-light text-dark border">delay</span>
                </div>
            </div>
            <div class="card-footer bg-white border-0 pt-0">
                <a href="<?= base_url('examples/queue') ?>" class="demo-btn" style="background:#6f42c1;">
                    <i class="bi bi-arrow-right-circle"></i> 예제 보기
                </a>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center gap-3 mb-3">
                    <div class="rounded-circle d-flex align-items-center justify-content-center"
                        ...
                        <i class="bi bi-collection-play-fill fs-4" style="color:#0dcaf0;"></i>
                    </div>
                    <div>
                        <h5 class="mb-0">CI4 공식 Queue 시스템</h5>
                        <small class="text-muted">codeigniter4/queue 패키지</small>
                    </div>
                </div>
                <p class="text-muted small mb-3">공식 <code>codeigniter4/queue</code> 패키지로 Database 핸들러 기반 잡 추가·처리·재시도·우선순위·체이닝 실습. DIY 큐(#40)와 비교.</p>
                <div class="d-flex flex-wrap gap-1 mb-3">
                    <span class="badge bg-light text-dark border">push/pop</span>
                    <span class="badge bg-light text-dark border">queue:work</span>
                    <span class="badge bg-light text-dark border">setDelay</span>
                    <span class="badge bg-light text-dark border">chain</span>
                    <span class="badge bg-light text-dark border">retry</span>
                </div>
            </div>
            <div class="card-footer bg-white border-0 pt-0">
                <a href="<?= base_url('examples/official-queue') ?>" class="demo-btn" style="background:#0dcaf0;color:#000;">
                    <i class="bi bi-arrow-right-circle"></i> 예제 보기
                </a>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center gap-3 mb-3">
                    <div class="rounded-circle d-flex align-items-center justify-content-center"
                        ...
                        <i class="bi bi-clock-history fs-4" style="color:#6610f2;"></i>
                    </div>
                    <div>
                        <h5 class="mb-0">Task Scheduler</h5>
                        <small class="text-muted">codeigniter4/tasks 패키지</small>
                    </div>
                </div>
                <p class="text-muted small mb-3">공식 <code>codeigniter4/tasks</code>로 클로저·커맨드·셸 등 다양한 유형의 태스크를 cron 없이 등록·스케줄·수동 실행까지 실습.</p>
                <div class="d-flex flex-wrap gap-1 mb-3">
                    <span class="badge bg-light text-dark border">closure</span>
                    <span class="badge bg-light text-dark border">command</span>
                    <span class="badge bg-light text-dark border">everyMinute</span>
                    <span class="badge bg-light text-dark border">daily</span>
                    <span class="badge bg-light text-dark border">environments</span>
                </div>
            </div>
            <div class="card-footer bg-white border-0 pt-0">
                <a href="<?= base_url('examples/taskscheduler') ?>" class="demo-btn" style="background:#6610f2;">
                    <i class="bi bi-arrow-right-circle"></i> 예제 보기
                </a>
            </div>
        </div>
    ...
    <!-- 49. AG Grid -->
    <div class="col-md-6 col-xl-4">
        <div class="card h-100 border-0 shadow-sm" style="border-top: 4px solid #1f7245 !important;">
            <div class="card-body">
                <div class="d-flex align-items-center gap-3 mb-3">
                    <div class="rounded-circle d-flex align-items-center justify-content-center"
                         style="width:48px;height:48px;background:#e8f5e9;">
                        <i class="bi bi-table fs-4" style="color:#1f7245;"></i>
                    </div>
                    <div>
                        <h5 class="mb-0">AG Grid</h5>
                        <small class="text-muted">데이터 그리드 연동</small>
                    </div>
                </div>
                <p class="text-muted small mb-3">AG Grid Community와 CI4 JSON API 연동. 클라이언트 사이드 정렬·필터·페이지네이션 및 서버 사이드 Infinite Row Model 구현.</p>
                <div class="d-flex flex-wrap gap-1 mb-3">
                    <span class="badge bg-light text-dark border">정렬·필터</span>
                    <span class="badge bg-light text-dark border">페이지네이션</span>
                    <span class="badge bg-light text-dark border">서버사이드</span>
                    <span class="badge bg-light text-dark border">CSV 내보내기</span>
                </div>
            </div>
            <div class="card-footer bg-white border-0 pt-0">
                <a href="<?= base_url('examples/aggrid') ?>" class="demo-btn" style="background:#1f7245;">
                    <i class="bi bi-arrow-right-circle"></i> 예제 보기
                </a>
            </div>
        </div>

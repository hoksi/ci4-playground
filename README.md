...
- **53개 예제** — 기초부터 실무 패턴까지 전 범위 커버
- **드롭다운 네비게이션** — 6개 카테고리 + 예제 하단 이전/다음 버튼
...
| 52 | **챗봇** | Groq AI(LLaMA 3.1 8B) 연동 — 대화 컨텍스트 유지, `.env` API 키 지원 |
| 53 | **고양이 키우기** | 다마고찌 스타일 AI 게임 — 시간 경과 상태 감소, Groq AI 반응 생성, CSS 애니메이션 |
